...
本目錄是**開發者導向**的技術文件庫,說明「現行程式碼長什麼樣子」。內容以 2026-07-04(issue #68 品質處理完成後,`issue-68-quality` 分支)的程式碼實況為準,會隨程式碼演進而更新。
...
| [`07_擴充藍圖.md`](./07_擴充藍圖.md) | **未來方向**(非現狀):資料型別描述檔、表格處理管線、UI registry、新 API 決策 checklist |
